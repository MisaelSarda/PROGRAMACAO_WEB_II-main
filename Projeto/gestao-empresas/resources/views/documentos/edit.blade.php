...
<div class="max-w-xl mx-auto bg-white p-6 mt-8 rounded shadow">
    ...
    <form action="{{ route('documentos.update', \$documento) }}" method="POST" enctype="multipart/form-data" class="space-y-4">
        @csrf
        @method('PUT')
        ...
        <div>
            ...
            <input type="date" name="validade" value="{{ old('validade', $documento->validade) }}" class="w-full border rounded px-3 py-2 shadow-sm">
