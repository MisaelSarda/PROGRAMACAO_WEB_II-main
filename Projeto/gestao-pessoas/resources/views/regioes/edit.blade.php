...
<div class="max-w-2xl mx-auto bg-white p-6 mt-8 rounded shadow">
    ...
    <form action="{{ route('regioes.update', $regiao->id) }}" method="POST">
        ...
        <div>
            ...
            <input type="text" name="nome" value="{{ old('nome', $regiao->nome) }}"
                   class="w-full border rounded px-3 py-2 shadow-sm focus:outline-none focus:ring focus:border-blue-300">
            @error('nome')
